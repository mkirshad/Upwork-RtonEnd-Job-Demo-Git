...
export const helpTopics: HelpTopic[] = [
    ...
    },
    {
        ...
        links: [
            ...
            {
                label: 'Open warehouses workspace',
    ...
    },
    {
        ...
        links: [
            ...
            {
                label: 'Open purchasing workspace',
    ...
    },
    {
        ...
        title: 'POS Register',
        summary:
            'Touch friendly order entry that works online or offline with automatic sync once connectivity returns.',
        bullets: [
            'Choose a register to load the current shift, float, and pending drawer notes.',
            'Process orders with barcode scans or quick keys; offline carts queue in IndexedDB until synced.',
            'Close the shift, reconcile cash, and download the audit log for finance.',
        ],
        links: [
            {
